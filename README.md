...
<p align="center">
  ...
  <a href="docs/rules.md">61 rules</a> ·
...
pnpm dlx @shadscan/cli@0.10.0 --fail-under 80 --no-interactive --no-roast
  ...
  audit:
    ...
    steps:
      ...
      - uses: TheOrcDev/shadscan@main
        with:
          path: .
          version: 0.10.0 # pin an exact CLI version in CI
          fail-under: "80"
          create-issue: "true"
```
...
The bundled ruleset contains 61 deterministic checks across six weighted
categories.
