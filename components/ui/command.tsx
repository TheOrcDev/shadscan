...
function CommandInput({
  ...
  return (
    <div
      className="m-1 flex h-9 items-center gap-2 border bg-input/50 px-3"
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      className={cn(
        "no-scrollbar max-h-72 scroll-py-1 overflow-y-auto overflow-x-hidden outline-none focus-visible:ring-2 focus-visible:ring-ring",
        className
      )}
